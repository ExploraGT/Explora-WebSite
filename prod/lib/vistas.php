...
function showMenu(){
    print"
        <div class='NavMenu'>
			  ...
			  <div class='menu'>
				 <ul>
					 <li class='submenu-web-dev' id='webDev'><a href='http://www.explora.gt/paginasWeb.php#'><b>WEB DEVELOPMENT</b></a>
						 <ul>
					 ...
					 <li class='submenu-analytics' id='analytics'><a href='http://www.explora.gt/analytics.php#'><b>ANALYTICS</b></a>
					     <ul>
							<li><a href='http://www.explora.gt/analytics.php#modelos'><b>Modelos</b></a><hr noshade='noshade'/></li>
							<li><a href='http://www.explora.gt/analytics.php#insights'><b>An&aacute;lisis & Insights</b></a><hr noshade='noshade'/></li>
							<li><a href='http://www.explora.gt/analytics.php#herramientas'><b>Herramientas</b></a><hr noshade='noshade'/></li>
							<li><a href='http://www.explora.gt/analytics.php#analisis-datos'><b>Fuentes de datos</b></a></li>
						 </ul>
					 </li>
					 <!--li id='branding'><a href=''><b>BRANDING</b></a></li>
					 <li id='portafolio'><a href=''><b>PORTAFOLIO</b></a></li>
					 <li id='team'><a href=''><b>TEAM</b></a></li-->
					 <li id='contacto'><a href='#contactoExplora'><amp-img srcset='resources/css/img/icons/phone.png' height='25px' width='25px'></amp-img></a></li>
				 </ul>
			  </div>
		</div>
    ";
		   ...
		   <div class='contactoExplora-form'>
				...
				<div>
					<form method='GET' action='lib/enviar_contacto.php'>
						...
						<textarea id='proy_modal' name ='proy_modal' class='proy-modal' placeholder='Informaci&oacute;n del servicio que necesitas' rows='10' cols='50' required></textarea>
